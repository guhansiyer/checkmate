...
def imgEdit(num):
    ...
    img = cv.imread(f"C:\\Users\\guhan\\Desktop\\chess\\realChessPNGs (coloured)\\Move" + str(num) + ".png")
    ...
    mask = cv.rectangle(mask, (131, 235), (475, 585), (255,255,255), -1)
    ...
    cv.imwrite(f"{config.path}\\PNGs\\cutPhotos\\Move" + str(num) + ".png", img_final)
